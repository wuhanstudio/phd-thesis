...
In this chapter, we focus on adversarial attacks against image classification models. Image Classification is one of the most fundamental tasks in computer vision that associate pre-defined labels with each image. Existing image classification models are accurate enough and have been widely adopted in real-world applications, such as Google Cloud Vision, Amazon Rekognition, OpenAI, Imagga, etc.
