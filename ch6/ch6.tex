...
% % \par
% % To figure out whether those features are correctly ranked, there are two types of indicators for assessment and comparison of explanations: qualitative and quantitative indicators \cite{Carvalho_2019}. Faithfulbess is a qualitative indicator, and monotonicity is a quantitative indicator.
...
% \setcounter{figure}{3}
% \centering
% \includegraphics[width=3in]{fig/nature_dt.png}
...
\begin{figure*}
\centering
\includegraphics[width=6.16in]{fig/interpretable-ml-covid19.png}
...
\begin{subfigure}[b]{0.475\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/dt_pdp_crp_ntproBNP.png}
...
\begin{subfigure}[b]{0.475\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/rf_pdp_crp_ntproBNP.png}
...
\begin{subfigure}[b]{0.475\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/xgbc_pdp_crp_ntproBNP.png}
...
\begin{subfigure}[b]{0.475\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/nn_pdp_crp_ntproBNP.png}
...
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/dt_ice_crp_ntproBNP.png}
    \caption{Decision Tree}
    \label{fig:dt_ice}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/rf_ice_crp_ntproBNP.png}
    \caption{Random Forest}
    \label{fig:rf_ice}
\end{subfigure}
\hfill
...
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/xgbc_ice_crp_ntproBNP.png}
    \caption{Gradient Boosted Trees}
    \label{fig:gbt_ice}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/nn_ice_crp_ntproBNP.png}
    \caption{Neural Networks}
    \label{fig:nn_ice}
\end{subfigure}
...
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/dt_ALE_NTproBNP_CRP.png}
    \caption{Decision Tree}
    \label{fig:dt_ale}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/rf_ALE_NTproBNP_CRP.png}
    \caption{Random Forest}
    \label{fig:rf_ale}
\end{subfigure}
\hfill
...
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/xgbc_ALE_NTproBNP_CRP.png}
    \caption{Gradient Boosted Trees}
    \label{fig:gbt_ale}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.485\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/nn_ALE_NTproBNP_CRP.png}
    \caption{Neural Networks}
    \label{fig:nn_ale}
\end{subfigure}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_dt_5.png}
    \caption{Decision Tree}
    \label{fig:lime_dt_5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_rf_5.png}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_xgbc_5.png}
    \caption{Gradient Boosted Trees}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_nn_5.png}
    \caption{Neural Networks}
    \label{fig:lime_nn_5}
\end{subfigure}
...
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_dt_5.png}
    \caption{Decision Tree}
    \label{fig:shap_dt_5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_rf_5.png}
    \caption{Random Forests}
    \label{fig:shap_rf_5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_xgbc_5.png}
    \caption{Gradient Boosted Trees}
...
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_nn_5.png}
    \caption{Neural Networks}
    \label{fig:shap_nn_5}
\end{subfigure}
\hfill
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_dt_2.png}
    \caption{Decision Tree}
    \label{fig:lime_dt_2}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_rf_2.png}
    \caption{Random Forests}
    \label{fig:lime_rf_2}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_xgbc_2.png}
    \caption{Gradient Boosted Trees}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_nn_2.png}
    \caption{Neural Networks}
    \label{fig:lime_nn_2}
\end{subfigure}
\hfill
...
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_dt_2.png}
    \caption{Decision Tree}
    \label{fig:shap_dt_2}
\end{subfigure}
\hfill
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_rf_2.png}
    \caption{Random Forests}
    \label{fig:shap_rf_2}
\end{subfigure}
\hfill
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_xgbc_2.png}
    \caption{Gradient Boosted Trees}
...
\begin{subfigure}[b]{1.0\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/shap_nn_2.png}
    \caption{Neural Networks}
    \label{fig:shap_nn_2}
\end{subfigure}
\hfill
...
% \setcounter{figure}{3}
\centering
\includegraphics[width=2.8in]{fig/nature_dt.png}
\caption{A decision rule using three key features and their thresholds in
absolute value. Num, the number of patients in a class; T, the number of
correctly classified; F, the number of misclassified patients. \cite{Yan2020}}
\end{figure}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_kaggle_dt.png}
    \caption{Decision Tree}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_kaggle_rf.png}
    \caption{Random Forests}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_kaggle_xgbc.png}
    \caption{Gradient Boosted Trees}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fig/lime_kaggle_nn.png}
    \caption{Neural Networks}
