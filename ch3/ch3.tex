...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/chapter_detection/detection/grid.jpg}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.6\textwidth}
        \includegraphics[width=1\linewidth]{figures/chapter_detection/detection/multi_untargeted_aspect_success.png}
...
The optimization of \eqref{eq_adversarial_opt} is performed by first zero-initializing the perturbation $\delta$, and then using Projected Gradient Descent (PGD) \cite{madry2017towards} with learning rate decay  in every iteration $t$ , so that 
\begin{equation}
